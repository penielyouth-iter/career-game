...
const cells:BoardCell[]=[
 ...
 {id:2,type:"teamGrowth",label:"團隊一起成長",icon:"📚",description:"你分享最近學到的一個方法，選擇一位其他玩家一起討論。你們兩人都獲得經驗值 +20。",choice:"teamGrowth"},
 ...
 {id:6,type:"communication",label:"合作討論",icon:"💬",description:"你和夥伴一起討論，聽見不同想法後，找到更好的做法，經驗值 +20。",effects:{experience:20}},
 {id:7,type:"support",label:"隊友支援金錢",icon:"🤝",description:"你最近有點低落，需要隊友支援。選擇一位其他玩家，讓他給你 30 金幣。",choice:"support"},
 ...
 {id:14,type:"chance",label:"機會",icon:"✨",description:"新的好機會出現了，抽一張符合目前角色階段的機會卡，看看這次會得到什麼幫助。"},
