...
const cells:BoardCell[]=[
 ...
 {id:2,type:"reading",label:"閱讀",icon:"📚",description:"你讀到一本有幫助的書，學會新的想法，也找到可以用在職涯旅程上的方法，經驗值 +20。",effects:{experience:20}},
 ...
 {id:7,type:"support",label:"隊友支援",icon:"🤝",description:"你最近有點低落，需要隊友幫忙打氣。選擇一位其他玩家，讓他給你 30 金幣。",choice:"support"},
