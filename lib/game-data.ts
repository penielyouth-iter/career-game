...
const characterShells:Omit<CharacterConfig,"cards">[]=[
 {id:"goto",name:"後藤一豪",job:"工程師",instrument:"鍵盤手",icon:"🎹",color:"#72c7ff",initial:stats(0,500),titles:careerTitles.goto,stageIntros:stageIntros.goto,milestones:milestones("工程師")},
 {id:"zoey",name:"Zoey",job:"偶像",instrument:"主唱",icon:"🎤",color:"#ff7eb6",initial:stats(0,300),titles:careerTitles.zoey,stageIntros:stageIntros.zoey,milestones:milestones("偶像")},
 {id:"zhang",name:"張玉曼",job:"企業家",instrument:"鼓手",icon:"🥁",color:"#ffb65b",initial:stats(0,100),titles:careerTitles.zhang,stageIntros:stageIntros.zhang,milestones:milestones("企業家")},
 {id:"rubio",name:"盧比歐",job:"牧師",instrument:"吉他手",icon:"🎸",color:"#8bd48b",initial:stats(0,300),titles:careerTitles.rubio,stageIntros:stageIntros.rubio,milestones:milestones("牧師")},
 {id:"esports",name:"小明",job:"電競選手",instrument:"滑鼠手",icon:"🕹️",color:"#7c8cff",initial:stats(0,300),titles:careerTitles.esports,stageIntros:stageIntros.esports,milestones:[
...
export function newGame(config:GameConfig):GameState{
 ...
 return{started:false,turnOrder:playerSlots.map(slot=>slot.id),turnIndex:0,round:1,accelerated:false,players:Object.fromEntries(playerSlots.map((slot,index)=>{
  ...
  return[slot.id,{characterId:character?.id||"",portraitId:slot.portraitId,position:0,stage:0,stats:{...(character?.initial||stats(0,0))},skipTurns:0,finishedAt:null,decks:{},stageIntroSeen:[]}];
